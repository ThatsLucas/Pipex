...
/*   Updated: 2024/12/05 16:53:39 by lle-duc          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_check_type(char c, va_list params, int *c_cnt)
{
	char	*s;
...
static int	ft_check_type_base(char c, va_list params, int *c_cnt)
{
	long	i;
